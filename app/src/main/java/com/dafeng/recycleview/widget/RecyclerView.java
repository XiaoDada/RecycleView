...
import com.dafeng.recycleview.R;
...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.isAutoMeasureEnabled()) {
            ...
            // consistency
            //在第二步中设置尺寸。为了保持一致性，预先布局应该使用旧的尺寸
                ...
                if (holder != null) {
                    ...
                    if (!validateViewHolderForOffsetPosition(holder)) {
                        ...
                        if (!dryRun) {
                            ...
                            /**
                             * 先大体看一下第一级缓存，可以看到，
                             * 这里通过getScrapOrHiddenOrCachedHolderForPosition方法来获取ViewHolder，
                             * 并检验holder的有效性，如果无效，则从mAttachedScrap中移除，
